...
TEST(string_map_test, asignar) {
    ...
    singleton.insert(make_pair("abc", 1));

    EXPECT_EQ(singleton.at("abc"), 1);
...
TEST(string_map_test, obtener) {
    ...
    EXPECT_EQ(sin_prefijos.count("hola"),1);
    EXPECT_EQ(sin_prefijos.count("chau"),1);
    EXPECT_EQ(sin_prefijos.count("adios"),1);
...
TEST(string_map_test, redefinir) {
    ...
    EXPECT_EQ(con_prefijos.count("c"),1);
    EXPECT_EQ(con_prefijos.count("casa"),1);
    EXPECT_EQ(con_prefijos.count("casona"),1);
    EXPECT_EQ(con_prefijos.count("coca"),0);
