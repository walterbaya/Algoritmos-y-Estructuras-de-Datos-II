...
TEST(string_map_test, insert){
    string_map<int> nuevo;
    nuevo.insert(make_pair("abc", 3));
    nuevo.insert(make_pair("abb", 4));
    nuevo.insert(make_pair("abba", 4));
    nuevo.insert(make_pair("cba", 5));
    nuevo.insert(make_pair("cba", 6));
    ASSERT_EQ(4, nuevo.at("abba"));
    ASSERT_TRUE(nuevo.size() == 4);
    nuevo.erase("abb");
    nuevo.erase("abba");
    nuevo.erase("cba");
    nuevo.erase("abc");
